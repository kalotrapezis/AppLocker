...
Detection uses the **2023mar** YuNet (needs OpenCV ≥ 4.7, which Kubuntu 26.04's
4.10 satisfies). On an old 4.6 box the engine falls back to the 2022mar model if
you drop it in manually; both are handled by SFaceEngine._try_yunet.
